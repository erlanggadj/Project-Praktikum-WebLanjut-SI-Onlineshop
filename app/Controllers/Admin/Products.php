...
class Products extends BaseController
{
    ...
    public function store()
    {
        ...
        session()->setFlashdata('success', 'Product has been saved.');
    ...
    public function destroy($id)
    {
        ...
        if (empty($product->deleted_at)) {
            ...
            session()->setFlashdata('success', 'Product has been deleted permanently.');
    ...
    public function restore($id)
    {
        ...
        if ($product->deleted_at) {
            ...
            session()->setFlashdata('success', 'Product has been restored.');
            return redirect()->to('/admin/products');
        }
    }
    ...
    public function doUploadImage($productId)
    {
        ...
        if ($path) {
            ...
            session()->setFlashdata('success', 'Image has been saved.');
            return redirect()->to('/admin/products/' . $productId . '/images');
        }

        session()->setFlashdata('error', 'Image upload failed.');
        return redirect()->to('/admin/products/' . $productId . '/images');
    }
    ...
    public function destroyImage($id)
    {
        ...
        session()->setFlashdata('success', 'Image has been deleted.');
