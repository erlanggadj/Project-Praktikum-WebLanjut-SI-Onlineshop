            ...
            <div class="row">
                <div class="col-6 text-left">
                    <ul class="top-links contact-info">
                        <li><i class="fa fa-envelope-o"></i> <a href="#">TrioGemezz@gmail.com</a></li>
                        <li><i class="fa fa-whatsapp"></i> +062 8569 7898/li>
                    </ul>
                </div>
                <div class="col-6 text-right">
                    ...
                    <?php if (logged_in()): ?>
                        ...
                        <li><i class="fa fa-power-off"></i> <a href="/logout">Logout ( <?php echo user()->username ?> )</a></li>
                         <?php else:  ?>
                        <li><i class="fa fa-user-circle-o"></i> <a href="<?php echo site_url('register') ?>">Register</a></li>
                        <li><i class="fa fa-power-off"></i> <a href="<?php echo site_url('login') ?>">Login</a></li>
                    <?php endif; ?>
                    </ul>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-6">
                    <a class="navbar-brand mr-lg-5" href="./index.html">
                        <i class="fa fa-shopping-bag fa-3x"></i> <span class="logo">ONLINE SHOP</span>
                    </a>
                </div>
